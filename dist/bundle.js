...
var bundle = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			p = element("p");
    			p.textContent = `What's the meaning of life? ${/*a*/ ctx[1]}`;
    			add_location(h2, file, 5, 2, 91);
    			add_location(p, file, 6, 2, 120);
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*$timer*/ 1) set_data_dev(t1, /*$timer*/ ctx[0]);
    		},
    		i: noop,
    		o: noop,
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ timer, a, $timer });
